---
title: "Showcase web API with ASP.NET Core"
author: joe-ibarra
description: Building a web API with ASP.NET Core and custom media types and Auth0.
ms.author: Jose-Ibarra
ms.custom: mvc, devx-track-js
ms.date: 09/13/2021
no-loc: [Home, Privacy, Kestrel, appsettings.json, "ASP.NET Core Identity", cookie, Cookie, Angular, "Identity", "Let's Encrypt", Models]
uid: tutorials/first-web-api
---

# Tutorial: Create a web API with ASP.NET Core

By [Jose Ibarra](https://joeibarra.dev/)

This is a basic web API with ASP.NET Core.
